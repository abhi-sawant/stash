    ...
    <div
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: spacing.lg }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 700, color: colors.text }}>Create an account</h1>
          <p style={{ fontSize: 14, color: colors.textSecondary, marginTop: 6 }}>
            Get free cloud backups for your bookmarks
          </p>
        </div>
        ...
        <div
          ...
          <p style={{ fontSize: 12, color: colors.textTertiary, textAlign: 'center', lineHeight: 1.5 }}>
